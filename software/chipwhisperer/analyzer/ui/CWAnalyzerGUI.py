...
from chipwhisperer.analyzer.external.mat2chipwhisperer import mat2cw
...
class CWAnalyzerGUI(CWMainGUI):
    ...
    def addToolMenuItems(self):
        ...
        self.toolMenu.addAction(QAction('Matlab ' + u"\u2122" +' to Chipwhisperer Converter', self,
                                        statusTip='Convert ' + u"\u2122" +' Matlab captures to a Chipwhisperer Project',
                                        triggered=mat2cw.main))
